...
<body class="hold-transition login-page"> 
 ...
 echo '<div class="alert alert-danger"><button type="button" class="close" datadismiss="alert"><i class="ace-icon fa fa-times"></i></button><strong><i class="ace-icon fa fa-ban"></i> GAGAL!<br></strong> '.$this->session->flashdata('gagal').'</div>';         }     ?> 
 
    <?=form_open('auth/checkAuth', 'method="post"')?>       
    <div class="form-group has-feedback">         
    	<input type="text" name="username" class="form-control" maxlength="20" placeholder="Username" required autofocus>         <span class="glyphicon glyphicon-user form-control-feedback"></span>       
    </div>       
    <div class="form-group has-feedback">         
    	<input type="password" name="password" class="form-control" placeholder="Password" required autofocus>         <span class="glyphicon glyphicon-lock form-control-feedback"></span>       
    </div>       
    <div class="row">         
    	<div class="col-xs-8">           
    	...
    	<!-- /.col -->         
    			...
    			<div class="col-xs-4">           
    				<button type="submit" name="submit" class="btn btn-primary btn-block btnflat">Sign In &nbsp;<i class="fa fa-sign-in"></i></button>         
    			</div>         
    			<!-- /.col -->       
    		</div>     
    		<?=form_close()?> 
  ...
  <hr>   <!-- footer -->   
  <div class="text-center">     Hak Cipta &copy; 2018 &nbsp;<a href="<?=base_URL()?>"><strong>SIM JALAK</strong></a>   </div>   <!-- /.footer -->   
  <hr> 
