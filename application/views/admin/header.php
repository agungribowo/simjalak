...
<html>
	<head>
		...
		<!-- Font Sans Google -->
		<link rel="stylesheet" href="<?=base_URL()?>assets/components/font-google/sans- google.css">
			...
			<ul class="nav navbar-nav">
				...
				<li class="dropdown user user-menu">
					<a href="javascript:void(0)" class="dropdown-toggle" data-toggle="dropdown">
						<img src="<?=base_URL().'assets/images/user/'.$foto?>" class="user-image" alt="Foto Profil">
